...
{
    public partial class ucTaxUserSalary : UserControl
    {
        public ucTaxUserSalary()
        {
            InitializeComponent();
        }

        private void ucTaxUserSalary_Load(object sender, EventArgs e)
        {
            loadEmployee();
        }
        void loadEmployee()
        {
            DataTable dt = TextUtils.Select("select ID, Code, FullName from TaxEmployee");
        ...
        public bool save(ref TaxEmployeeModel Usermodel)
        {
