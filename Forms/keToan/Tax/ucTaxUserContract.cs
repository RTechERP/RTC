...
{
    public partial class ucTaxUserContract : UserControl
    {
        public ucTaxUserContract()
        {
            InitializeComponent();
        }

        private void ucTaxUserContract_Load(object sender, EventArgs e)
        {
            loadCb();
        ...
        public void loadData(ref TaxEmployeeModel employee)
        {
            loadCb();
            if (employee.ID > 0)
            {
                ...
                if (employee.TinhTrangKyHD == rdChuaky.Text)
                {
                    rdChuaky.Checked = true;
                }
                else
                {
                    rdDaky.Checked = true;
