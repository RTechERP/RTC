...
namespace BMS
{
    public partial class frmProjectWorker_New : _Forms
    {
        ...
        private void btnAddVersion_Click(object sender, EventArgs e)
        {
            ...
            var frm = Application.OpenForms.OfType<frmProjectPartListVersion>().FirstOrDefault();

            if (frm != null && frm.statusVersion == 1)
            {
                // nếu đã mở thì đưa ra front
                frm.Activate();
                frm.BringToFront();
            }
            else
            {
                ...
                frm = new frmProjectPartListVersion(1);
                frm.statusVersion = 1;
                frm.projectId = project.ID;
                frm.projectSolutionId = projectSolutionId;
                ...
                frm.Show();
                // Nếu muốn modal thì dùng frm.ShowDialog();
            }
        }
        ...
        private void btnAddSolution_Click(object sender, EventArgs e)
        {
            ...
            // kiểm tra trong danh sách form đang mở
            var frm = Application.OpenForms.OfType<frmProjectSolutionDetail>().FirstOrDefault();
            ...
            {
                // nếu chưa mở thì tạo mới
                frm = new frmProjectSolutionDetail();
                frm.projectId = TextUtils.ToInt(project.ID);
                frm.projectRequestId = 0;

                frm.SaveEvent += () => LoadProjectSolution();
        ...
        private void btnAddVersionPO_Click(object sender, EventArgs e)
        {
            ...
            if (frm != null && frm.statusVersion == 2)
            {
                frm.Activate();
                frm.BringToFront();
            }
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            ...
            // Check trong list form hiện có
            foreach (Form f in Application.OpenForms)
            {
                if (f is frmProjectWorkerDetail frmOpen &&
                    frmOpen.ProjectWorkerVersionID == versionID && // check theo version
                    frmOpen.projectID == project.ID &&             // check theo project
                    frmOpen.ID == 0)                               // check form "New" (chưa có worker)
                {
                    f.Activate();
                    return;
                }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                if (f is frmProjectWorkerDetail frmOpen &&
                    frmOpen.ProjectWorkerVersionID == versionID &&
                    frmOpen.projectID == project.ID &&
                    frmOpen.ID == workerID) // check workerID để đảm bảo đúng form
                {
                    f.Activate();
                    return;
                }
