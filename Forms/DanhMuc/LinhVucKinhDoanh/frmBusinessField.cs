...
namespace BMS
{
    public partial class frmBusinessField : _Forms
    {
        ...
        void loadData()
        {
            ...
            if (business.ID > 0)
            {
                nupSTT.Value = business.STT; 
                txtCode.Text = business.Code;
                txtName.Text = business.Name;
                txtNote.Text = business.Note;
            }
            else
            {
                business = SQLHelper<BusinessFieldModel>.FindAll().OrderByDescending(x => x.ID).FirstOrDefault();
                nupSTT.Value = business != null ? business.STT + 1 : 1;
        ...
        bool saveData()
        {
            ...
            business.STT = TextUtils.ToInt(nupSTT.Value);
        ...
        private void frmBusinessField_KeyDown(object sender, KeyEventArgs e)
        {
