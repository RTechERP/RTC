...
namespace BMS
{
	public partial class frmBillImportDetailProductsHCM : _Forms
	{
		int warehouseID = 0;
		...
		public frmBillImportDetailProductsHCM(int warehouseID)
		{
			InitializeComponent();
			this.warehouseID = warehouseID;
		}

		private void frmBillImportDetailProductsHCM_Load(object sender, EventArgs e)
		{
