...
namespace BMS
{
	partial class frmIventoryBorrowNCCProductsHCM
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmIventoryBorrowNCCProductsHCM));
			...
			// 
			// frmIventoryBorrowNCCProductsHCM
			// 
			...
			this.Name = "frmIventoryBorrowNCCProductsHCM";
			this.Text = "BÁO CÁO MƯỢN NHÀ CUNG CẤP";
			this.Load += new System.EventHandler(this.frmIventoryBorrowNCCProductsHCM_Load);
