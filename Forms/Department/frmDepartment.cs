...
namespace BMS
{
    public partial class frmDepartment : _Forms
    {
        ...
        private void ClearInterface()
        {
            ...
            //colSTT.SortOrder = DevExpress.Data.ColumnSortOrder.Ascending;
        }
        ...
        private void LoadData()
        {
            try
            {
                DataTable tbl = TextUtils.Select("Select a.*, Case when a.Status = 0 then N'Ngừng hoạt động' else N'Hoạt động' end StatusText from Department a with(nolock) ORDER BY STT ASC");
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            txtSTT.Text = grvData.GetRowCellValue(grvData.FocusedRowHandle, "STT").ToString();
            txtCode.Text = grvData.GetRowCellValue(grvData.FocusedRowHandle, "Code").ToString();
            cboStatus.SelectedIndex = Convert.IsDBNull(grvData.GetRowCellValue(grvData.FocusedRowHandle, "Status")) == true ? 0 : Convert.ToInt16(grvData.GetRowCellValue(grvData.FocusedRowHandle, "Status"));
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dModel.STT = TextUtils.ToInt(txtSTT.Text);
