...
namespace BMS
{
    public partial class frmInventoryBorrowNCCDemo : _Forms
    {
        public int warehouseID;
        int totalReturnNCC = 0;
        public frmInventoryBorrowNCCDemo()
        {
            InitializeComponent();
        }
        private void frmInventoryBorrowNCCDemo_Load(object sender, EventArgs e)
        {
