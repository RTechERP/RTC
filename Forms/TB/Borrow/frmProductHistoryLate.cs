...
namespace BMS
{
    public partial class frmProductHistoryLate : _Forms
    {
        ...
        public int Status = -1;
        public frmProductHistoryLate()
        {
            InitializeComponent();
        }
        public frmProductHistoryLate(int WarehouseID)
        {
            InitializeComponent();
        ...
        private void frmListTool_Load(object sender, EventArgs e)
        {
            ...
            //btnDeleteHistory.Visible = Global.IsAdmin;
        }
                    ...
                    if (selectedRowHandle >= 0)
                    {
                        ...
                        else
                        {
                            if (Global.IsAdmin || isAdmin/* Global.UserID == 24 || Global.UserID == 88*/)//Check là admin, Admin HN, Admin HCM
                            {
                                ...
                                //HuyNV_5/11/2022
                                //Không cần update lại số lượng trong bảng ProductRTC
        ...
        {
            frmProductHistoryLate frm = new frmProductHistoryLate();
            frm.ShowDialog();
        }
