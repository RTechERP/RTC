...
{
    public partial class frmBillImportTechDetail : _Forms
    {
        public bool IsEdit;
        public int IDDetail;
        ...
        public frmBillImportTechDetail()
        {
            InitializeComponent();
        }
        public frmBillImportTechDetail(int WarehouseID)
        {
            InitializeComponent();
        ...
        {
            DataTable data = TextUtils.LoadDataFromSP("spGetAllDocumentImportByPONCCID", "A", new string[] { "@PONCCID", "@BillImportID" }, new object[] { poNCCId, billImport.ID });
