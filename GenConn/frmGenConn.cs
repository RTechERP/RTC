...
namespace GenConn
{
    public partial class frmGenConn : Form
    {
        ...
        {
            txtConnection.Text = this.EncodeChecksum("Server={0};"+string.Format("database={0};uid={1};pwd={2}"
                //, txtServer.Text.Trim()
        ...
        private void btnDecrypt_Click(object sender, EventArgs e)
        {
            ...
            string[] arr = this.DecodeChecksum(txtConnection.Text.Trim()).Split(';');
            txtServer.Text = arr[0].Split('=')[1].Trim();
            txtDatabase.Text = arr[1].Split('=')[1].Trim();
            txtuid.Text = arr[2].Split('=')[1].Trim();
            txtpwd.Text = arr[3].Split('=')[1].Trim();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                File.WriteAllText(f.SelectedPath+ "\\default.ini", txtConnection.Text.Trim());
            }
        }
        ...
        private void btnOpen_Click(object sender, EventArgs e)
        {
            ...
            {
                txtConnection.Text = File.ReadAllText(o.FileName);
        ...
        private void btnTest_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(ok ? "OK" : "Lỗi kết nối");
        }
        ...
        {
            txtpwd.PasswordChar = chkShowPass.Checked ? '\0' : '*';
        }
    }
}
