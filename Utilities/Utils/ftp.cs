...
namespace BMS
{
    public class ftp
    {
        ...
        private static string host = "ftp://10.20.28.199", user = "lethe.anh", pass = "RTC@lta.1";
        ...
        /* Construct Object */
        public static void ftp_load(string hostIP, string userName, string password)
        {
            host = hostIP;
            user = userName;
            pass = password;
        ...
        public static void UploadFile(string filePath, string ftpFolderPath)
        {
            ...
            reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri(host + "/" + ftpFolderPath + "/" + fileInf.Name));
        ...
        public static bool UploadFileWithStatus(string filePath, string folderPath)
        {
            try
            {
                ...
                //string uri = "ftp://" + ftpServerPath + "/" + fileInf.Name;
                FtpWebRequest reqFTP;
                if (!CheckExits(folderPath))
                {
                    MakeDir(folderPath);
                }
                // Create FtpWebRequest object from the Uri provided
                reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri(host + "/" + folderPath + "/" + fileInf.Name));
        ...
        public static void UploadFile(string filename)
        {
            ...
            // Create FtpWebRequest object from the Uri provided
            reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri(host + "/" + fileInf.Name));
        ...
        public static void UploadFile(string sourceName, string saveName, ProgressBar progBar, Label lblProgress)
        {
            ...
            FtpWebRequest reqFTP;
            reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri(host + "/" + saveName));
            reqFTP.Credentials = new NetworkCredential(user, pass);
            reqFTP.KeepAlive = false;
            reqFTP.Method = WebRequestMethods.Ftp.UploadFile;
            reqFTP.UseBinary = true;
        ...
        public static void UploadFile(string sourceName, string saveName, string folderPath, ProgressBar progBar, Label lblProgress)
        {
            FileInfo fileInf = new FileInfo(sourceName);
            FtpWebRequest reqFTP;
            reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri(host + "/" + folderPath + "/" + saveName));
            reqFTP.Credentials = new NetworkCredential(user, pass);
            reqFTP.KeepAlive = false;
            reqFTP.Method = WebRequestMethods.Ftp.UploadFile;
            reqFTP.UseBinary = true;
        ...
        public static void DownloadFile(string localPath, string saveName, string ftpFilePath, ProgressBar progBar, Label lblProgress)
        {
            ...
            {
                //Create FTP request
                FtpWebRequest request = FtpWebRequest.Create(host + "/" + ftpFilePath) as FtpWebRequest;
                ...
                request = FtpWebRequest.Create(host + "/" + ftpFilePath) as FtpWebRequest;
        ...
        public static string[] GetFilesDetailList()
        {
            try
            {
                ...
                FtpWebRequest ftp;
                ftp = (FtpWebRequest)FtpWebRequest.Create(new Uri(host + "/"));
        ...
        public static string[] GetFilesDetailList(string path)
        {
            try
            {
                ...
                StringBuilder result = new StringBuilder();
                FtpWebRequest ftp;
                ftp = (FtpWebRequest)FtpWebRequest.Create(new Uri(host + "/" + path));
                ftp.Credentials = new NetworkCredential(user, pass);
                ftp.Method = WebRequestMethods.Ftp.ListDirectoryDetails;
                WebResponse response = ftp.GetResponse();
                StreamReader reader = new StreamReader(response.GetResponseStream());
        ...
        public static long GetFileSize(string filePath)
        {
            ...
            try
            {
                reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri(host + "/" + filePath));
        ...
        public static string GetDateModified(string filePath)
        {
            ...
            try
            {
                reqFTP = (FtpWebRequest)FtpWebRequest.Create(host + "/" + filePath);
        ...
        public static void Rename(string currentFilename, string newFilename)
        {
            ...
            try
            {
                reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri(host + "/" + currentFilename));
        ...
        public static void MakeDir(string dirName)
        {
            ...
            try
            {
                ...
                string path = host;
                string[] subFolders = dirName.Split('/');
        ...
        public static bool CheckExits(string path)
        {
            ...
            try
            {
                string pathFolder = host + "/" + path;
                FtpWebRequest request = FtpWebRequest.Create(pathFolder) as FtpWebRequest;
                request.Credentials = new NetworkCredential(user, pass);
