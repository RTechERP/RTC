...
namespace BMS
{
    public partial class ProjectSurveyFileModel : BaseModel
    {
        ...
        public int? ProjectSurveyDetailID { get; set; } // int, null
    }
    public enum ProjectSurveyFileModel_Enum{
        ID,
        ProjectSurveyID,
        FileName,
        OriginPath,
