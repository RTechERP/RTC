    ...
    public class Permissions
    {
        ...
        public static void CheckControls(object parentControl)
        {
            ...
            try
            {
                ...
                if (parentControl is XtraTabControl)
                {
                    var xtraTab = (XtraTabControl)parentControl;
                    foreach (XtraTabPage item in xtraTab.TabPages)
                    {
                        if (item.Tag != null && !item.Tag.ToString().Equals(""))
                        {
                            DataRow dr = CheckPermission(item.Tag.ToString());
                            if (dr == null)
                            {
                                item.PageEnabled = false;
                            }    
                            else
                            {
                                item.PageEnabled = true;
                            }
                        }
                        CheckControls(item);
                    }
                ...
                if (parentControl is ToolStrip)
                {
                    ...
                    foreach (ToolStripItem item in menu.Items)
                    {
                        ...
                        else
                        {
                            if (!_IsUserControl)
                            {
                                if (item.Name.ToLower().Contains("btnsave"))
                                {
                                    item.Tag = "S, Control";
                                    item.ToolTipText = "Ctrl + S";
                                }
                                if (item.Name.ToLower().Contains("btnsavenew"))
                                {
                                    item.Tag = "Right, Control";
                                    item.ToolTipText = "Ctrl + Right";
                                }
                                if (item.Name == "btnOK")
                                {
                                    item.Tag = "Q, Control";
                                ...
                                if ((item.Name.ToLower().Contains("btnexport") || item.Name.ToLower().Contains("btnexcel")) && item.Enabled == true)
                                {
                                    item.Tag = "O, Control";
                                    item.ToolTipText = "Ctrl + O";
                                }
                ...
                if (parentControl is DevExpress.XtraBars.Ribbon.RibbonControl)
                {
                    ...
                    foreach (DevExpress.XtraBars.BarItem item in _ribbonControl.Items)
                    {
                ...
                #region BarDockControl
                if (parentControl is BarDockControl)
                {
                    BarDockControl bar = (BarDockControl)(parentControl as BarDockControl).Controls.Owner;
                    //var a = bar.Manager.Items;
                    if (bar.Manager == null) return;
